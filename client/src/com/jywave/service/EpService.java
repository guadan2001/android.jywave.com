...
public class EpService {
	...
	public Ep getEp(int id)
	{
		...
		case 1:
			...
			ep.url = "http://192.168.0.100/podcast/jyshock037.mp3";
			ep.coverUrl = "http://android.jywave.com/images/jyshock037.jpg";
		...
		case 2:
			...
			ep.url = "http://192.168.0.100/podcast/jyshock036.mp3";
			ep.coverUrl = "http://android.jywave.com/images/jyshock036.jpg";
			ep.publishDate = new Date();
			break;
		case 3:
			ep.id = 3;
			...
			ep.url = "http://192.168.0.100/podcast/jyhadouken028.mp3";
			ep.coverUrl = "http://android.jywave.com/images/jyhadouken028.jpg";
			ep.publishDate = new Date();
			break;
		case 4:
			ep.id = 4;
			...
			ep.url = "http://192.168.0.100/podcast/jyshock035.mp3";
			ep.coverUrl = "http://android.jywave.com/images/jyshock035.jpg";
			ep.publishDate = new Date();
			break;
		}
